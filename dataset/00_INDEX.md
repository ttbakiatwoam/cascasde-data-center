# Cascade Data Center Research Dataset
...
This directory converts the major research threads developed in the Cascade Data Center project into reusable Markdown notes with public source links.

The goal is to create a traceable evidence base that can be used for:

- ordinance and development-agreement research;
...
## Privacy and exclusion rule

This dataset intentionally does **not** contain:

- Facebook comments or reply drafts;
- screenshots of private/local social-media discussions;
- identities of private commenters;
- private disputes or threats;
- law-enforcement correspondence;
- private email correspondence;
- home addresses, phone numbers, personal email addresses, or other personal contact information;
- biographical information about the individual who assembled the research.

Public agencies, companies, laws, ordinances, public institutional documents, and published journalism remain identified where necessary to make the sources traceable.

## Evidence labels

The notes distinguish four source categories wherever the distinction matters:
...
### 1. Match the facility before comparing it

A useful comparator should match as many of these variables as possible:

- MW;
- footprint;
- containerized vs. conventional building;
- workload;
...
### 2. Separate normal operation from failures

An accidental water-line rupture, code violation, or unmetered connection is evidence about infrastructure and enforcement. It should not automatically be reported as normal cooling consumption.
...
The project-generated accountability ordinance is preserved because it contains useful policy ideas and source references. It is not City of Cascade law.
