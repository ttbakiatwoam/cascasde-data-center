# Project Overview and Public Timeline
...
- **public record** — adopted resolutions, council minutes, ordinances, statutes, permits, and official government pages;
- **company claim** — statements made by Simple Mining about its own fleet, technology, or operations;
- **secondary reporting** — local or trade reporting about the proposed Cascade site;
...
Data Center Dynamics, citing local reporting, described a proposal involving roughly four acres in the Cascade Industrial Park and approximately 40 containerized cryptocurrency-mining units, each described as roughly 160 square feet. This is useful early-stage reporting, not a final approved site plan.

### June 22, 2026 — City Council action

Cascade City Council minutes record public discussion of a data-center moratorium. The minutes also record a statement that the project scope had changed in early May and a representation that the proposed facility would use a closed-loop water system. The council approved Resolution 57-26 establishing a 12-month moratorium on construction of data centers within Cascade city limits, with interim benchmarks contemplated during that period.

### July 27, 2026 — advisory committee created

Council minutes record approval of Resolution 70-26 establishing an advisory committee to prepare a data-center ordinance.

### August 10, 2026 — committee populated

Council minutes record approval of Resolution 79-26 appointing members to the Data Center Advisory Committee. Individual member names are intentionally omitted from this dataset.
...
- A Simple Mining-related project has been under consideration in Cascade.
...
- City of Cascade — 2026 City Council records index: https://www.cityofcascade.org/vnews/display.v/ART/6959ce08641c7
