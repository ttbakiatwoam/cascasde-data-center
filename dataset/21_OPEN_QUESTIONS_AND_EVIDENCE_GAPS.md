...
- **Documented** — supported by a public record or source document.
- **Represented** — stated by the company or in public discussion but not independently verified for the final design.
...
| Question | Current status | Evidence needed |
|---|---|---|
| Pre/post stormwater runoff | Unknown | Civil/stormwater study |
| Downstream drainage impacts | Unknown | Civil/hydraulic analysis |
| Erosion/sediment controls | Unknown | Construction SWPPP/civil plans |
| Generator emissions | Unknown | Generator schedule and permits |
| Electronic-waste handling | Unknown | Waste-management plan |
| Fuel/coolant spill containment | Unknown | SPCC/process plan as applicable |
| Independent environmental review | Policy proposal | Scope and consultant report if required |
...
## Taxes, incentives, and public costs
...
| Clawbacks/performance guarantees | Unknown | Development agreement |

West Des Moines and other projects show what is possible under different agreements; those numbers are not Cascade forecasts.
...
| State/federal preemption issues | Needs legal review | Permit-by-permit legal analysis |
| Public-record/security confidentiality | Needs legal review | Iowa Chapter 22/application-specific analysis |

## Monitoring, expansion, and decommissioning
...
- cooling/heat-rejection design;
- distance to nearby receptors;
- measured noise;
- actual water use;
- permanent staffing;
- documented complaints/violations, if any;
- local tax/infrastructure arrangement.

A named comparable site would allow Cascade to replace speculative analogies with a real operating dataset.

## Sources establishing the current framework

- Simple Mining hosting: https://www.simplemining.io/hosting
- Simple Mining water article: https://www.simplemining.io/insights/post/data-center-water-usage
- Data Center Dynamics early Cascade proposal report: https://www.datacenterdynamics.com/en/news/simple-mining-plans-bitcoin-mining-expansion-in-dubuque-county-iowa/
- City of Cascade 2026 Council records: https://www.cityofcascade.org/vnews/display.v/ART/6959ce08641c7
- June 22, 2026 Council Minutes: https://www.cityofcascade.org/vimages/shared/vnews/stories/6959ce08641c7/June%2022%202026%20Council%20Minutes.pdf
